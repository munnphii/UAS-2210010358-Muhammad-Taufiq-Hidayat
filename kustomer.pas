...
begin
  ...
  if DataModule1.Zkustomer.Locate('nik', edtNik.Text, []) then
  begin
...
begin
  ...
  else if not DataModule1.Zkustomer.Locate('nik', edtNik.Text, []) then
  begin
...
begin
  ...
  cbMember.Text := DataModule1.Zkustomer.FieldByName('member').AsString;
